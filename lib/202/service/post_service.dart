...
class PostService implements IPostService {
  ...
  @override
  Future<List<PostModel>?> fetchPostItemsAdvance() async {  //Dataları çekeceğiz.
   try {
      final response = await _dio.get(_PostServicePaths.posts.name); //Böyle yazmamamız gerek
